...
<a
    ...
    @class([
        'sh-news-hero group relative block overflow-hidden rounded-card border border-line bg-surface-soft shadow-surface',
        'h-full' => (bool) $fill,
    ])
>
    <div
        @class([
            'sh-news-hero-media relative aspect-[16/9] w-full overflow-hidden bg-surface-soft',
    ...
    <div class="sh-news-hero-content absolute bottom-0 w-full p-4">
        ...
        <h2 class="sh-news-hero-title text-right text-xl font-extrabold leading-snug text-white sm:text-2xl lg:text-3xl">
            {{ $article->title }}
        </h2>
    </div>
</a>
